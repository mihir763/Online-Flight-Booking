...
<footer>
	...
	<p class="text-light text-center"><h6 class="text-light text-center"> POPULAR GLOBEHUNTERS DESTINATIONS </h6>
<h6 class="text-light text-center"> 
Alaska Airlines Flights <br>
American Airlines Flights <br>
Delta Airlines Flights <br>
Flight Deals <br>
Jetblue Flights <br>
Southwest Airlines Flights <br>
United Airlines Flights </h7>
</footer>