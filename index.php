...
<link rel="stylesheet" type="text/css"
	...
	<h1 class="text-light brand mt-2">
		...
		<p class="text-light brand mt-2" > Need to book or change a current flight? Our team is standing by 24/7 to provide you with stress free booking experience. call us now, there are NO WAIT TIME and we can assist you with any of your airline flight needs in just minutes!</p>
		
		<h4 class="text-light brand mt-4" >Reservations, Cancellations & Flight Changes </h4> 
		<div class="sap_tabs">			
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4  intro_col">
                                    <div class="intro_item d-flex flex-row align-items-end justify-content-start">
                                        ...
                                        <div class="intro_content">
                                            <div class="intro_title">24/7 CUSTOMER SUPPORT </div>
                                            <div class="intro_subtitle">
                                                <p>We’re happy to help with New Reservations, Cancellations, and Flight Change questions. Our experienced customer success representatives can assist you with your new or upcoming flight 24/7. NO WAIT TIMES to book flights with almost any airline.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 intro_col">
                                    <div class="intro_item d-flex flex-row align-items-end justify-content-start">
                                        <div class="intro_icon"></div>
                                        <div class="intro_content">
                                            <div class="intro_title">COMPARE FLIGHT COSTS </div>
                                            <div class="intro_subtitle"><!-- log on to codeastro.com for more projects -->
                                                <p>Get the best deals on flights anywhere in the world. We can help you navigate the terms of each airline before booking, so you can book the flight you need with a worry free guarantee.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
								...
								<div class="col-lg-4 intro_col">
                                    <div class="intro_item d-flex flex-row align-items-end justify-content-start">
                                        <div class="intro_icon"></div>
                                        <div class="intro_content">
                                            <div class="intro_title">AIRLINES SERVICED </div>
                                            <div class="intro_subtitle"><!-- log on to codeastro.com for more projects -->
                                                <p>United Airlines , Delta Airlines , Volaris Airlines , Allegiant Airlines , Spirit Airlines British Airways , American Airlines , Air Canada , Alaska Airlines , Frontier Airlines , Southwest Airlines , Qatar Airlines , Emirates Airlines , PLUS MANY MORE...</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<!-- <div class="conatiner-fluid p-4" style="background-color: whitesmoke;margin-top:150px;"> -->
	...
	<em><h5 class="text-light text-center p-0 brand mt-2">
				<height="40px" width="40px" alt="">				
					877-713-4752</h5></em>
	<div class="text-light text-center">We are Currently Experiencing NO HOLD Times!<br><br>
    
</div>
<h3 class="text-light text-center"> New Reservations, Flight Cancellations & Flight Changes </h3
	<!-- <p>----------</p> -->
